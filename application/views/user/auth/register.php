    ...
    html[data-bs-theme="light"] .lpx-form-side .text-gray-900, html[data-bs-theme="light"] .lpx-form-side .text-gray-800,
    html[data-bs-theme="light"] .lpx-form-side .text-gray-700{ color:#10182f !important; }
    html[data-bs-theme="light"] .lpx-form-side .text-gray-500, html[data-bs-theme="light"] .lpx-form-side .text-gray-600,
    html[data-bs-theme="light"] .lpx-form-side .text-muted{ color:#64708a !important; }
    ...
    .lpx-brand-side{ flex:1 1 0; min-width:0; position:relative; display:flex; align-items:center; justify-content:center; overflow:hidden;
        min-height:620px; border-radius:32px; padding:56px 52px;
