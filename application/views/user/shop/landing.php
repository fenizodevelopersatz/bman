		...
		<div class="mn-main-content sb-hide">
			<div class="row">
				<div class="col-xxl-12">
						...
						<section class="mn-hero swiper-container m-b-15">
							<div class="mn-hero-slider owl-carousel">
								<?php foreach ($sliders as $slide): ?>
									<div class="mn-hero-slide swiper-slide"
										style="background-image:url('<?= base_url($slide->image) ?>')">
										<div class="mn-hero-detail">
											<p class="label"><span><?= nl2br($slide->label_text) ?></span></p>
											<h1><?= $slide->heading ?></h1>
											<p><?= $slide->sub_heading ?></p>
											<?php if (!empty($slide->button_url)): ?>
												<a href="<?= $slide->button_url ?>" class="mn-btn-2">
					...
					<section class="mn-category p-tb-15">
						<div class="mn-cat owl-carousel">
							<?php foreach ($categories as $cat): ?>
								<div class="mn-cat-card cat-card-<?= $cat->id ?>">
									<p class="lbl"><span><?= $cat->max_offer ?>%</span></p>
									<span class="bg"><?= $cat->max_offer ?>%</span>
									<h4><?= ucfirst($cat->name) ?></h4>
									<p>Items (<?= count($cat->products) ?>)</p>
									<ul>
										<?php foreach ($cat->products as $product): ?>
											<li>
												<a href="<?= base_url('user/shop-list') ?>">
													<img src="<?= base_url('assets/images/' . $product->product_image) ?>"
														alt="<?= $cat->name ?>">
												</a>
											</li>
										<?php endforeach; ?>
							...
							<?php foreach ($new_arrivals as $product): ?>
								<div class="mn-product-card">
									<div class="mn-product-img">
										...
										<div class="mn-img">
											<a href="<?= base_url('user/shop/product-view/' . $product->id) ?>"
												class="image">
												<img class="main-img"
													src="<?= base_url('assets/images/' . $product->product_image) ?>"
													alt="<?= $product->name ?>">
												<img class="hover-img"
													src="<?= base_url('assets/images/' . $product->product_image) ?>"
													alt="<?= $product->name ?>">
													...
													<?php if ($this->session->userdata('userid')): ?>
														...
														<li>
															<a href="javascript:void(0)" title="Wishlist"
																class="add-to-wishlist " data-product="<?= $product->id ?>">
																<i class="ri-heart-line <?= $wishlist_active ?>"></i>
															</a>
														</li>
														<li>
															<a href="javascript:void(0)" title="Add To Cart"
																class="add-to-cart " data-product="<?= $product->id ?>">
																<i class="ri-shopping-cart-line <?= $cart_active ?>"></i>
															</a>
														</li>
													<?php else: ?>
														<li>
															<a href="<?= base_url('user/in') ?>"
									...
									<div class="mn-product-detail">
										...
										<h5><a href="#"><?= $product->category_name ?> | <?= $product->brand_name ?></a>
										</h5>
										<div class="mn-price">

											<?php if ($product->offer_price > 0 && $product->offer_status == "1"): ?>
												<div class="mn-price-new"><?php echo currency_info()->currency_symbol; ?>
													<?= $product->offer_price ?>
												</div>
											<?php else: ?>
												<div class="mn-price-new"><?php echo currency_info()->currency_symbol; ?>
											...
											<?php endif; ?>
											<?php if ($product->offer_price > 0 && $product->offer_status == "1"): ?>
												<div class="mn-price-old"><?php echo currency_info()->currency_symbol; ?>
													<?= $product->price ?>
												</div>
											<?php endif; ?>
							...
							<div class="mn-ser-content mn-ser-content-3 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
								...
								<div class="mn-ser-box">
									<div class="mn-ser-inner">
										<div class="mn-service-image">
											<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512"
												height="512" x="0" y="0" viewBox="0 0 512 511"
												style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
												<g>
													<path
							...
							<div class="mn-ser-content mn-ser-content-4 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
								...
								<div class="mn-ser-box">
									<div class="mn-ser-inner">
										<div class="mn-service-image">
											<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512"
												height="512" x="0" y="0" viewBox="0 0 511 512"
									...
									<div class="modern-banner">
										...
										<div class="mn-banner-contact banner-animation">
											...
											<div class="banner-btn">
												<a href="#" class="mn-btn-1"><span>Book
														Now</span></a>
											</div>
										</div>
									</div>
					...
					<section class="mn-testimonials p-tb-15 d-none">
						<div class="row">
							<div class="col-md-12">
								<div class="testim-bg">
									...
									<div class="mn-test-outer mn-testimonials">
										<ul class="mn-testimonial-slider owl-carousel">
											<li class="mn-test-item">
												<img src="<?php echo base_url(); ?>assets/shop/img/icons/top-quotes.svg"
												...
												<img src="<?php echo base_url(); ?>assets/shop/img/icons/bottom-quotes.svg"
								...
								<?php foreach ($blogs as $blog): ?>
									<div class="mn-blog-card">
										<div class="blog-info">
											...
											<div class="detail">
												<label><?= date('F d, Y', strtotime($blog->created_at)) ?> -
													<a href="#"><?= $blog->category_name ?></a>
												</label>
												<h3><a href="<?= base_url('blog-detail/' . $blog->slug) ?>"><?= $blog->title ?></a></h3>
												<div class="more-info">
													<a href="<?= base_url('blog-detail/' . $blog->slug) ?>">Read More
							...
							<div class="mn-insta-outer">
								<div class="insta-auto">
									...
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/1.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/2.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/3.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/4.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
									...
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/5.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
									...
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/6.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
									...
									<div class="mn-insta-item">
										<div class="mn-insta-inner">
											<a href="#" target="_blank"><img
													src="<?php echo base_url(); ?>assets/shop/img/instagram/7.jpg"
													alt="insta"></a>
										</div>
									</div>
									<!-- instagram item -->
							...
							<div class="col-md-7 col-sm-12 col-xs-12 mb-24">
								<div class="quickview-pro-content">
									<h5 class="mn-quick-title">
										<a href="#">Best cotton fabric women's half sleeve
