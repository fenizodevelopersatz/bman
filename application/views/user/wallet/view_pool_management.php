<?php $this->load->view('user/layout/user_style');?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-px text-center pt-15 pb-15">
                                            <!--begin::Title-->
                                        <h2 class="fs-2x fw-bold mb-0">Leg Pool Overview</h2>
                                            <!--end::Title-->

                                            <!--begin::Description-->
                                            <p class="text-gray-500 fs-4 fw-semibold py-7">
                                                Get a detailed breakdown of your Leg Pool earnings and bonuses across all activities within the platform.
                                            </p>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Heading-->
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $total_left_mining; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Left Leg Lending</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $total_left_active; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Left Leg  Member</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $total_right_mining; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Right Leg Lending</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $total_right_active; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Right Leg  Member</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold fs-3 mb-1">Leg Pool History</span>
