                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-px text-center pt-15 pb-15">
                                            <!--begin::Title-->
                                        <h2 class="fs-2x fw-bold mb-0">Ranking Overview</h2>
                                            <!--end::Title-->

                                            <!--begin::Description-->
                                            <p class="text-gray-500 fs-4 fw-semibold py-7">
                                                Get a detailed breakdown of your Rank earnings and bonuses across all activities within the platform.
                                            </p>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Heading-->
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $Totalrankreward; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Rank Reward</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $Currentmonthrank; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Current Month Rank</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $Currentpoolmatch; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Current Pool Match</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1">
                                                        <?php echo $leftpool + $rightpool; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Team Lending Pool</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-5 mb-xxl-8">
                                                        ...
                                                        <div class="card-header mb-4 border-transparent">
                                                            <h3 class="anchor fw-bold "><?php echo "Rank Transaction";?></h3>
                                                        </div>
                                                            ...
                                                            <div class="col-lg-3 mb-4">
                                                                <div class="d-flex align-items-center position-relative my-1 gap-7">
                                                                    ...
                                                                    <select class="form-select me-3" data-control="select2" id="call_status" data-placeholder="Filter Types" multiple>
                                                                        <option></option>
                                                                        <option value="rank">Achived Rank</option>
                                                                        <option value="rank_commission">Rank Commission</option>
                                                                    </select>
        ...
        const agent_id = '<?php echo $user_id;?>';
         ...
         $(document).ready(function(){
                    ...
                    datatable = $(table).DataTable({
                        ...
                        ajax: {
                            ...
                            data: function(d) {
                                ...
                                d.call_status = (callStatus && callStatus.length > 0) ? callStatus : ["rank", "rank_commission"]
                            }
                        },
                        columns: [
                            { data: 'RecordID' },
            ...
            function loadData(){
                ...
                var callStatus = $('#call_status').val();
                call_status = (callStatus && callStatus.length > 0) ? callStatus : ["rank", "rank_commission"]
