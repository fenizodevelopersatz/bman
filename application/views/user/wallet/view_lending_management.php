                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-px text-center pt-15 pb-15">
                                            <!--begin::Title-->
                                        <h2 class="fs-2x fw-bold mb-0">Lending Overview</h2>
                                            <!--end::Title-->

                                            <!--begin::Description-->
                                            <p class="text-gray-500 fs-4 fw-semibold py-7">
                                                Get a detailed breakdown of your Lending earnings and bonuses across all activities within the platform.
                                            </p>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Heading-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1"><?php echo $today_bonus; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Today Bonus</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex align-items-center mb-2 gap-5">   
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1"><?php echo $total_bonus; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Bonus</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="col-md-6 mb-xl-10">
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex align-items-center mb-2 gap-5">   
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1"><?php echo $Totalllendigpool; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Lending</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                            ...
                                            <div class="card card-flush ">
                                                ...
                                                <div class="card-header pt-7">
                                                    ...
                                                    <div class="card-title flex-stack flex-row-fluid">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                                                <span class="symbol-label bg-light-info">
                                                    <i class="fa-solid fa-receipt fs-2x text-primary"></i>
                                                       </span>
                                                    </div>
                                                        <!--end::Symbol-->
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex align-items-center mb-2 gap-5">   
                                                    <div>
                                                    <span class="fs-4 fw-bold text-gray-800 me-2 lh-1 ls-n2 counted" id="user_token_balance" data-kt-initialized="1"><?php echo $lendingpools; ?></span>
                                                    </div>
                                                    </div>
                                                    <span class="fw-bold fs-7 text-gray-500">Total Lending Count</span>
                                                </div>
                                                    <!--end::Wrapper-->
                                                </div>
                                                <!--end::Card body-->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-5 mb-xxl-8">
                                                        ...
                                                        <div class="card-header mb-4 border-transparent">
                                                            <h3 class="anchor fw-bold "><?php echo "Lending Transaction";?></h3>
                                                        </div>
                                                            ...
                                                            <div class="col-lg-3 mb-4">
                                                                <div class="d-flex align-items-center position-relative my-1 gap-7">
                                                                    ...
                                                                    <select class="form-select me-3" data-control="select2" id="call_status" data-placeholder="Filter Types" multiple>
                                                                        <option></option>
                                                                        <option value="mining">Lending</option>
         ...
         $(document).ready(function(){
                    ...
                    datatable = $(table).DataTable({
                        ...
                        ajax: {
                            ...
                            data: function(d) {
                                ...
                                d.call_status = (callStatus && callStatus.length > 0) ? callStatus : ["mining", "profit"]
                            }
                        },
                        columns: [
                            { data: 'RecordID' },
            ...
            function loadData(){
                ...
                var client_filter = $('#client_filter').val(); 
                     var callStatus = $('#call_status').val();
                call_status = (callStatus && callStatus.length > 0) ? callStatus : ["mining", "profit"]
