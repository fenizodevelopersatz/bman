<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
            ...
            <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                ...
                ?>
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        ...
                        <?php $action = base_url()."social-link-update-marketting"; ?>
                        <?= form_open($action, ['class' => 'form-validate', 'method' => 'post', 'autocomplete' => 'off', 'id' => 'kt_account_meta_details_form', "data-kt-redirect-url" => base_url()."social-link-marketting"]) ?>
                        ...
                        <?php if (!empty($social_links)) : ?>
                            <?php foreach ($social_links as $link) : ?>
                                ...
                                <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-semibold fs-6"><?= $link['social_name']; ?> Link <span class="text-danger"> * </span></label>
                                ...
                                <input type="text" name="social_link[]" class="form-control form-control-lg form-control-solid" value="<?= $link['link']; ?>" required>
                                </div>
                                </div>
                                </div>
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/social_input.js?ver=2.9"></script>
