<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                               ...
                               <div id="kt_account_settings_profile_details" class="collapse show">
                                ...
                                <?= form_open_multipart($action, [
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <!-- Category Image -->
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Category Image <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                <div class="fv-row">
                                                    <div class="image-input image-input-outline" data-kt-image-input="true" 
                                                        style="background-image: url('<?= base_url(); ?>/assets/admin/media/svg/avatars/blank.svg')">
                                                        <?php
                                                        $imagePath = !empty($category_info->image) ? base_url($category_info->image) : base_url('assets/images/default.png');
                                                        ?>
                                                        ...
                                                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" 
                                                            data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change Category Image">
                                                            <i class="ki-duotone ki-pencil fs-7"><span class="path1"></span><span class="path2"></span></i>
                                                            <input type="file" name="category_image" accept=".png, .jpg, .jpeg">
                                                            <input type="hidden" name="category_image_remover">
                                                        </label>
                                        ...
                                        <div class="row mb-6 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Category Name <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                <input type="text" name="category_name" class="form-control form-control-solid" required
                                                    value="<?= set_value('category_name', $category_info->name ?? '') ?>" />
                                            </div>
                                        </div>


                                         <div class="row mb-6 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Category Description <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                            ...
                                            <div class="col-lg-8">
                                                <select name="parent_id" class="form-select form-select-solid" data-control="select2">
                                                    ...
                                                    <?php foreach ($categories as $cat): ?>
                                                        <option value="<?= $cat->id ?>" <?= ($category_info->parent_id == $cat->id) ? 'selected' : '' ?>>
                                                            <?= $cat->name ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <div class="form-text">Leave empty if this is a main category.</div>
                                            </div>
                                        </div>
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/category-admin.js?ver=2.9"></script>
