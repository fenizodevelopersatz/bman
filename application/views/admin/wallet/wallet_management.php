...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                                ...
                                <div class="card mb-5 mb-xl-10 ">
                                    ...
                                    <div id="kt_account_addagent_form_details" class="collapse show">
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6"> Balance Info
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 mb-3">
                                                            <div
                                                                class="border border-gray-300 border-dashed rounded col-lg-12 py-3 px-4 mb-3">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fs-2 fw-bold counted" id="main_balance"
                                                                        data-kt-initialized="1">0</div>
                                                                </div>
                                                                <div class="d-flex flex-stack">
                                                                    <div class="fw-semibold fs-6 text-success">Account
                                                                        Main Balance</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 mb-3 d-none">
                                                            <div
                                                                class="border border-gray-300 border-dashed rounded col-lg-12 py-3 px-4 mb-3">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fs-2 fw-bold counted" id="token_balance"
                                                                        data-kt-initialized="1">0</div>
                                                                </div>
                                                                <div class="d-flex flex-stack">
                                                                    <div class="fw-semibold fs-6 text-success">Account
                                                                        Token Main Balance</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row mb-6">
                                                    <label class="col-lg-4 col-form-label fw-semibold fs-6"> Select
                                                        Member <span class="text-danger"> * </span></label>
                                                    <div class="col-lg-8 fv-row">
                                                        <div class="input-group mb-5">
                                                            <select class="form-select form-select-solid"
                                                                data-control="select2" data-close-on-select="false"
                                                                id="memberSelect" name="selected_members"
                                                                ...
                                                                <?php if (COUNT($users) > 0) { ?>
                                                                    <?php foreach ($users as $list) { ?>
                                                                        <option value="<?php echo $list->id ?>">
                                                                            <?php echo $list->username . " ( " . $list->referral_id . " )"; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="col-lg-8 fv-row">
                                                        <div class="input-group mb-5">
                                                            <select class="form-select form-select-solid"
                                                                ...
                                                                data-placeholder="Select a payment type"
                                                                data-allow-clear="true">
                                                                <option></option>
                                                                <option value="currency">
                                                                    <?php echo $default_currency; ?> - ( Main Currency )
                                                                </option>
                                                ...
                                                <div class="row mb-6 mb-3">
                                                    <label class="col-lg-4 col-form-label fw-semibold fs-6"> Amount
                                                    </label>
                                                    <div class="col-lg-8 fv-row">
                                                        <input
                                                ...
                                                <div class="row mb-6 mb-3">
                                                    <label class="col-lg-4 col-form-label fw-semibold fs-6"> Notes by
                                                        user </label>
                                                    <div class="col-lg-8 fv-row">
                                                        <textarea
                                                            class="form-control form-control-lg form-control-solid mb-3"
                                                            name="notes_by_user" id="notes_by_user" rows="2" cols="10"
    ...
    <script src="<?php echo base_url(); ?>/assets/admin/js/custom/authentication/sign-in/add-wallet.js?ver=2.9"></script>
