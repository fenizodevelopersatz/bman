                ...
                ?>
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        ...
                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />  
                               ...
                               <div class="row mb-5">
                                <label class="col-lg-4 col-form-label fw-semibold fs-6"> Balance Info <span class="text-danger"> * </span></label>
                                ...
                                <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-semibold fs-6"> Select Member <span class="text-danger"> * </span></label>
                                <div class="col-lg-8 fv-row">
                                ...
                                <label class="col-lg-4 col-form-label fw-semibold fs-6"> Select Package <span class="text-danger"> * </span></label>
                                <div class="col-lg-8 fv-row">
                                <div class="input-group mb-5">
                                    <select class="form-select form-select-solid" 
                                    data-control="select2" data-close-on-select="false"  name="selected_package"
                                    data-placeholder="Select a package" data-allow-clear="true">
                                    <option></option>
                                    <?php if(COUNT($package) > 0){ ?>
                                    <?php foreach($package as $package_list){ ?>
                                        <option value="<?php echo $package_list->id?>"><?php echo $package_list->package_name.", Min Amt - ".currency_format($package_list->minimum).", Max Amt - ".currency_format($package_list->maximum); ?></option>
                                    <?php }?>
                                    <?php }?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-8 fv-row">
                                <input type="datetime-local" id="invest_date" 
                                value="<?php echo date('Y-m-d\TH:i'); ?>" 
                                name="invest_date" 
                                class="form-control form-control-solid ps-5 me-3" 
