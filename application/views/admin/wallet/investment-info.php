...
<div class="card card-flush pt-3 mb-5 mb-xl-10">
    ...
    <div class="card-body pt-3">
            ...
            <div class="d-flex flex-wrap py-5">
                ...
                <div class="flex-equal me-5">
                    ...
                    <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                        ...
                        <tbody>
                            ...
                            <!--begin::Row-->
                            <tr>
                                <td class="text-gray-500">Referral ID:</td>
                            ...
                            <!--end::Row-->
                             ...
                             <!--begin::Row-->
                             <tr>
                                <td class="text-gray-500">Payment BY:</td>
                ...
                <div class="flex-equal">
                    ...
                    <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-gray-500 min-w-175px w-175px">Package Name:</td>
                            ...
                            <!--begin::Row-->
                            <tr>
                                <td class="text-gray-500">Package Limit:</td>
                                <td class="text-gray-800">
                                <?php echo $min_max_package;?>
                                </td>
                            </tr>
                            <!--end::Row-->
                            ...
                            <!--begin::Row-->
                            <tr>
                                <td class="text-gray-500">Total Duration:</td>
                                <td class="text-gray-800">
                                <?php echo $pacakgeduration;?>
                                </td>
                            </tr>
                            <!--end::Row-->
                          <!--begin::Row-->
                          <tr>
                                <td class="text-gray-500">Payment URL:</td>
                                <td class="text-gray-800">
                                <?php echo $paymenturl;?>
                                </td>
                            </tr>
        ...
        <div class="mb-0">
            <!--begin::Title-->
            <h5 class="mb-4">Subscribed Info:</h5>
            <!--end::Title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-4 mb-0">
                    ...
                    <thead>
                        ...
                        <tr class="border-bottom border-gray-200 text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                            <th class="min-w-150px">Investment Date</th>
                            <th class="min-w-125px">Total Earning</th>
                            <th class="min-w-125px">Investment Status</th>
                            <th class="min-w-125px">Total Paid Amount</th>
                        </tr>
                        <!--end::Table row-->
                    </thead>
                    <!--end::Table head-->
