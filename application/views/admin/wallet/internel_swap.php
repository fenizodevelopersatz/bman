<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        ...
                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />  
                               ...
                               <div class="row mb-5">
                                ...
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">  Amount ( <?php echo $value_text; ?> )<span class="text-danger"> * </span></label>
                                <div class="col-lg-8 fv-row">
                                ...
                                <div class="row mb-6 mb-3">
                                <label class="col-lg-4 col-form-label fw-semibold fs-6"> Received Amount ( <?php echo $default_currency; ?> ) <span class="text-danger"> * </span></label>
                                <div class="col-lg-8 fv-row">
                                <input class="form-control form-control-lg form-control-solid mb-3" 
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/internel-swap.js?ver=2.9"></script>
