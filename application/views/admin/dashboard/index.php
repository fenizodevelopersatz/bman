<?php $this->load->view('admin/Layout/common_style');?>
    ...
    <style>
        ...
        .chart-container{ position:relative; height:360px; max-height:360px; }
        #mlmBarChart{ width:100% !important; height:100% !important; display:block; }
    </style>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                ...
                                <div class="d-flex flex-column flex-column-fluid">
                                    ...
                                    <div id="kt_app_content" class="app-content  flex-column-fluid mt-10">
                                        ...
                                        <div id="kt_app_content_container" class="app-container  container-xxl ">
                                            ...
                                            <?php $this->load->view('admin/dashboard/balance_info'); ?>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-5 mb-xxl-8">
                                                        ...
                                                        <div class="card-header mb-4 border-transparent">
                                                            <h3 class="anchor fw-bold "><?php echo "Recent Transaction List";?></h3>
                                                        </div>
                                                        ...
                                                        <div class="row justify-content-between das_ro">
                                                            ...
                                                            <span class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2 counted"  id="icd" data-kt-initialized="1">8,55</span>
                                                            </div>
                                                            ...
                                                            <span class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2 counted"  id="tcd" data-kt-initialized="1">8,55</span>
                                                            </div>
                                                            <div class="d-flex flex-stack">
        ...
        <div id="kt_scrolltop" class="scrolltop" data-kt-scrolltop="true">
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/transaction-list.js?ver=2.9"></script>
            <script>
            </script>
    </body>
