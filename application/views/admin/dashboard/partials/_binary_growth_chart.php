  ...
  <div class="card card-flush h-md-100">
    <div class="card-header pt-5">
      <h3 class="card-title align-items-start flex-column">
        ...
        <span class="text-muted mt-1 fw-semibold fs-7">New registrations vs. staking purchases vs. <span style="color:#EF4444;font-weight:700;">withdraw requests</span></span>
      </h3>
