<?php $this->load->view('admin/Layout/common_style');?>
                ...
                <div class="d-flex flex-wrap flex-stack">
                    <div class="d-flex flex-column flex-grow-1 pe-8">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value=""  id="total_downline_count" data-kt-initialized="1"></div>
                            </div>
                            <div class="fw-semibold fs-6 text-gray-500">Total Downline Count</div>
                            </div>
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                            <div class="d-flex align-items-center">
                            <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value=""  id="left_leg_count" data-kt-initialized="1"></div>
                            </div>
                            <div class="fw-semibold fs-6 text-gray-500">Level Income</div>
                            </div>
                            ...
                            <div class="fw-semibold fs-6 text-gray-500">PIN/Bonus</div>
                            </div>
                            ...
                            <div class="fw-semibold fs-6 text-gray-500">Rank</div>
                            </div>
                            ...
                            <div class="fw-semibold fs-6 text-gray-500">Purchase Income</div>
                            </div>
                    </div>
                </div>
                                                    ...
                                                    $wallets = $wallet_balance; // replace with your actual variable
                                                    ...
                                                    foreach ($wallets as $wallet) {
                                                        switch ($wallet->type) {
                                                            case 'direct_commission':
                                                                $direct_income = $wallet->balance_paise;
                                                                break;

                                                            case 'level_commission':
                                                                $level_income = $wallet->balance_paise;
                                                                break;

                                                            case 'pin':
                                                                $pin_bonus = $wallet->balance_paise;
                                                                break;

                                                            case 'commission_stage':
                                                                $rank_income = $wallet->balance_paise;
                                                                break;

                                                            case 'purchase':
                                                                $purchase_income = $wallet->balance_paise;
                                                                break;
                                                        }
                                                    }
                                                    ?>
                                                    ...
                                                    <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">
                                                                <?php echo number_format($direct_income / 100, 2); ?>
                                                            </div>
                                                ...
                                                <div class="col-xl-2">
                                                    ...
                                                    <a href="#" class="card bg-light-primary  hoverable card-xl-stretch mb-xl-8">
                                                        ...
                                                        <i class="ki-duotone ki-people text-primary fs-2x ms-n1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                            ...
                                                            <?php echo number_format($level_income / 100, 2); ?>
                                                            </div>
                                                ...
                                                <div class="col-xl-2">
                                                    ...
                                                    <a href="#" class="card bg-light-primary  hoverable card-xl-stretch mb-xl-8">
                                                        ...
                                                        <i class="ki-duotone ki-people text-primary fs-2x ms-n1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                            ...
                                                            <div class="card-title fw-bold text-primary fs-2 mb-3 d-block mt-5">
                                                           <?php echo number_format($pin_bonus / 100, 2); ?>
                                                            </div>
                                                ...
                                                <div class="col-xl-2">
                                                    ...
                                                    <a href="#" class="card bg-light-primary  hoverable card-xl-stretch mb-xl-8">
                                                        ...
                                                        <i class="ki-duotone ki-people text-primary fs-2x ms-n1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                            ...
                                                            <div class="card-title fw-bold text-primary fs-2 mb-3 d-block mt-5">
                                                            <?php echo number_format($rank_income / 100, 2); ?>
                                                            </div>
                                                ...
                                                <div class="col-xl-2">
                                                    ...
                                                    <a href="#" class="card bg-light-primary  hoverable card-xl-stretch mb-xl-8">
                                                        ...
                                                        <i class="ki-duotone ki-people text-primary fs-2x ms-n1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                            ...
                                                            <div class="card-title fw-bold text-primary fs-2 mb-3 d-block mt-5">
                                                           <?php echo number_format($purchase_income / 100, 2); ?>
                                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-5 mb-xxl-8">
                                                            ...
                                                            <div class="col-lg-6 mb-4">
                                                                <div class="d-flex align-items-center position-relative my-1 gap-7">
                                                                    ...
                                                                    <select class="form-select me-3" data-control="select2" id="call_status" data-placeholder="Filter Types" multiple>
                                                                        ...
                                                                        <?php
                                                                            $agent_name_get = $this->db->query("SELECT DISTINCT `reason` FROM `transactions` ORDER BY `reason` ASC")->result();                                                   
                                                                            if(count($agent_name_get)){ foreach($agent_name_get as $agent_name){ ?>
                                                                            <option value="<?php echo $agent_name->reason; ?>">
                                                                                <?php echo $agent_name->reason; ?>
                                                                            </option>
                                                                            <?php }} ?>
                                                        ...
                                                        <div class="row justify-content-between das_ro">
                                                            ...
                                                            <span class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2 counted"  id="icd" data-kt-initialized="1"><?php echo number_format($total_commission??0, 2); ?></span>
                                                            </div>
                                                            ...
                                                            <div class="d-flex align-items-center mb-2">   
                                                            <span class="fs-1 fw-semibold text-gray-500 me-1 mt-n1"><?php echo $total_commission ?? 0; ?></span>
 ...
 -->
                                                          ...
                                                          <table id="kt-client-follow-table"
                                    ...
                                    <h3 class="fw-bold m-0"><?php echo isset($card_title) ? $card_title :''; ?></h3>
                                    </div>
        ...
        <div id="kt_scrolltop" class="scrolltop" data-kt-scrolltop="true">
            ...
            #tree {
                min-width: 1200px;      /* allow horizontal growth */
                min-height: 600px;      /* allow vertical growth */
            }
...
//                     $('#details').html('<p>No rows</p>');
//                     return;
//                 }
//                 var html = '<table><tr><th>ID</th><th>Parent</th><th>Sponsor</th><th>Level</th></tr>';
//                 rows.forEach(r => {
//                     html += `<tr>
//                         <td>${r.user_id}</td>
//                         <td>${r.parent_id || '-'}</td>
...
//             if (!rows || rows.length === 0) {
//                 document.getElementById('tree').innerHTML = 'No data';
//                 return;
//             }

//             // Create table for Google Chart
//             const data = new google.visualization.DataTable();
//             data.addColumn('string', 'User');
//             data.addColumn('string', 'Parent');

//             const nodeMap = {}; // store nodes for click details
...
//                 // HTML shown inside each box
//                 const html = `
//                     <div class="node-small">
//                         <b>User:</b> ${id}<br>
//                         <b>Sponsor:</b> ${row.sponsor_id || '-'}<br>
//                         <b>Parent:</b> ${parent || 'ROOT'}<br>
//                         <b>Level:</b> ${row.level}
//                     </div>
//                 `;

//                 data.addRow([{ v: id, f: html }, parent]);
//             });
...
//                 const userId = data.getValue(sel[0].row, 0);
//                 showSidePanel(nodeMap[userId]);
//             });
//         }
//         $(function(){

//     // AUTO LOAD ROOT TREE
//     $.get("<?= base_url('mlm/view_downline?start='.$user_id) ?>")
//         .done(function(res){
//             if(res.status === 'ok'){
//                 renderTable(res.rows);
//                 drawOrgChart(res.rows);
//             }
//         });
