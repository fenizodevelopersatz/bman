...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content  flex-column-fluid mt-10">
                            ...
                            <div id="kt_app_content_container" class="app-container  container-xxl ">
                                            ...
                                            <div class="card-body pt-9 pb-9">
                                                ...
                                                <div class="d-flex flex-stack mb-5">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6  mb-2">
                                                                    <input type="date" id="cl_from_date"
                                                                        class="form-control form-control-solid w-250px ps-15 me-3"
                                                                        placeholder="Start Date">
                                                                </div>

                                                                <div class="col-lg-6  mb-2">
                                                                    <input type="date" id="cl_to_date"
                                                                        class="form-control form-control-solid w-250px ps-15  me-3"
                                                    ...
                                                    <div class="col-lg-4 mb-4">
                                                        <div
                                                            class="d-flex align-items-center position-relative my-1 gap-7">
                                                            <select
                                                                class="form-select form-select-solid form-select me-3"
                                                                id="client_filter" name="sponsor_id"
                                                    ...
                                                    <div class="d-flex flex-stack mb-5">
                                                        ...
                                                        <input type="text" data-kt-docs-table-filter="search"
                                                            ...
                                                            placeholder="Search SponserID" />
                                                    </div> -->

                                                        <div class="d-flex justify-content-end d-flex align-items-center position-relative my-1 float-right"
                                ...
                                <div class="modal fade" id="kt_modal_view_summary" tabindex="-1"
                                    aria-labelledby="kt_modal_view_summary_label" aria-hidden="true">
    ...
    <script
        src="<?php echo base_url(); ?>/assets/admin/js/custom/authentication/sign-in/withdraw-request-list.js?ver=2.9"></script>
    <script>
    </script>
