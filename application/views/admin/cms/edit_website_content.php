<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
            ...
            <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                ...
                ?>
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        ...
                        <?php $action = base_url()."website-content-update"; ?>
                        <?= form_open($action, ['class' => 'form-validate', 'method' => 'post', 'autocomplete' => 'off', 'id' => 'kt_account_meta_details_form',"data-kt-redirect-url"=> base_url()."website-content-cms"]) ?>
                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />  
                                      

                                <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">Section Name <span class="text-danger"> * </span></label>
                                ...
                                value="<?php echo $template_info->page_name; ?>" required readonly>
                                </div>
                                </div>
                                </div>

                                <input type="hidden" name="template_id" value="<?php echo $template_info->id; ?>" />

                                <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">  Section Content </label>
                                <div class="col-lg-12 fv-row">
                                <textarea class="form-control form-control-lg form-control-solid mb-3" rows="1" 
                                name="content" id="kt_docs_ckeditor_classic" 
                                rows="40" cols="120"
                                data-kt-element="input" placeholder="Enter Discription"><?php echo $template_info->content; ?></textarea>
                                </div>
                                </div>
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/edit-website-content.js?ver=2.9"></script>

            <script src="https://cdn.ckeditor.com/4.7.1/full/ckeditor.js"></script>
            <script>
                CKEDITOR.replace('content', {
                    allowedContent: true, // Allow all HTML tags, attributes, and classes
                    entities: false,
                    basicEntities: false,
                    htmlEncodeOutput: false,
                    extraAllowedContent: 'div(*)[*]{*};h1(*)[*]{*};h3(*)[*]{*}', // Allow all classes, attributes, and styles for div, h1, h3
