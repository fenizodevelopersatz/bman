<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                ...
                                <?= form_open_multipart($action, [
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="row mb-6 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Blog Category Name <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                         ...
                                         <div class="row mb-6 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Blog Category Description <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/blog-category-add.js?ver=2.9"></script>
