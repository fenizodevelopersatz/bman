<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-5 mb-xxl-8">
                                                        ...
                                                        <div class="d-flex justify-content-between mb-5">
                                                            <a href="<?php echo base_url();?>admin/add-blog-category" class="btn btn-primary">
                                                                Add Blog Category
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6 mb-4">
                                                            <div class="d-flex align-items-center position-relative my-1 gap-7">
                                                                ...
                                                                <select class="form-select me-3" data-control="select2" id="client_filter" data-placeholder="Filter an category" multiple>
                                                                    <option></option>
        ...
        <div id="kt_scrolltop" class="scrolltop" data-kt-scrolltop="true">
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/blog-category-list.js?ver=2.9"></script>
            <script>
            </script>
    </body>
