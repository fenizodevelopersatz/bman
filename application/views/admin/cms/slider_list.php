<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="card-body pt-9 pb-9">
                                                            ...
                                                            <div class="d-flex flex-stack mb-5">
                                                                ...
                                                                <div class="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    class="form-control form-control-solid w-250px ps-15" placeholder="Search Slider" />
                                                                </div>
                                                                
                                                                    <a href="<?php echo base_url();?>slider-add" class="btn btn-light-primary">
        ...
        <div id="kt_scrolltop" class="scrolltop" data-kt-scrolltop="true">
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/slider-content.js?ver=2.9"></script>
            <script>
            </script>
    </body>
