                                ...
                                <div class="card mb-5 mb-xl-10 ">
                                    ...
                                    <div id="kt_account_addagent_form_details" class="collapse show">
                                        <div class="card-body border-top p-9">
                                            ...
                                            <?php $action = base_url() . "faq-add"; ?>
                                            <?= form_open($action, ['class' => 'form-validate', 'method' => 'post', 'autocomplete' => 'off', 'id' => 'kt_account_meta_details_form', "data-kt-redirect-url" => base_url() . "faq-cms"]) ?>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <div class="input-group mb-5">
                                                        ...
                                                        <textarea type="text" name="faq_question"
                                                            class="form-control form-control-lg form-control-solid"
                                                            placeholder="Enter FAQ Question"
                                                            value="<?php echo $faq_question; ?>"
                                                            required><?php echo $faq_question; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-6">
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6">FAQ Answer<span
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <div class="input-group mb-5">
                                                        <span class="input-group-text border-transparent "
                                                            id="basic-addon1"><i
                                                                class="fa-solid fa-note-sticky "></i></span>
                                                        <textarea type="text" name="faq_answer"
                                                            class="form-control form-control-lg form-control-solid"
                                                            placeholder="Enter FAQ Answer"
                                                            value="<?php echo $faq_answer; ?>"
                                                            required><?php echo $faq_answer; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
