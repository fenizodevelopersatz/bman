<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
            ...
            <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                ...
                ?>
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        ...
                        <?php $action = base_url()."slider-add"; ?>
                        <?= form_open($action, ['class' => 'form-validate', 'method' => 'post', 'autocomplete' => 'off', 'id' => 'kt_account_meta_details_form',"data-kt-redirect-url"=> base_url()."slider-cms"]) ?>
                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />  
                                      
                 
                        <!-- <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Banner Title<span class="text-danger"> * </span></label>
                        ...
                        <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Banner File<span class="text-danger"> * </span></label>
                        <div class="col-lg-8 fv-row">
                        <div class="input-group mb-5">
                        <span class="input-group-text border-transparent " id="basic-addon1"><i class="fa-solid fa-note-sticky "></i></span>
                       ...
                       -->
                        ...
                        <div class="row mb-6 fv-row">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Banner Title <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                <input type="text" name="slider_title" class="form-control form-control-solid"
                                    value="<?= set_value('slider_title', $banner->title ?? '') ?>" placeholder="Title for internal use" required />
                            </div>
                        </div>

                        <!-- Banner Image -->
                        <div class="row mb-6 fv-row">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Banner Image <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                <input type="file" name="userfile" class="form-control form-control-solid" <?= empty($banner->slider_file) ? 'required' : '' ?> />
                                <?php if (!empty($banner->slider_file)): ?>
                                    <img src="<?= base_url($banner->slider_file) ?>" class="mt-3 rounded" style="height: 100px;" />
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Banner Show<span class="text-danger"> * </span></label>
                        <div class="col-lg-8 fv-row">
                        <div class="input-group mb-5">
                        <img src="<?php echo $slider_file; ?>"
                        class="form-control form-control-lg form-control-solid" />
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="col-lg-8 fv-row">
                        <div class="input-group mb-5">
                        <video src="<?php echo $slider_file; ?>"  class="form-control form-control-lg form-control-solid"></video>
                        </div>
                        </div>
                        </div>
                        ...
                        <!-- Label Text -->
                        <div class="row mb-6 fv-row">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Label Text <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                <input type="text" name="label_text" class="form-control form-control-solid"
                                    value="<?= set_value('label_text', $banner->label_text ?? '') ?>" placeholder="e.g. 50% Off" required />
                            </div>
                        </div>

                        <!-- Main Heading -->
                        <div class="row mb-6 fv-row">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Main Heading <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                <textarea name="heading" class="form-control form-control-solid" rows="2" required><?= set_value('heading', $banner->heading ?? '') ?></textarea>
                            </div>
                        </div>

                        <!-- Subheading -->
                        <div class="row mb-6 fv-row">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Subheading</label>
                            <div class="col-lg-8">
                                <textarea name="sub_heading" class="form-control form-control-solid" rows="2"><?= set_value('sub_heading', $banner->sub_heading ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6 fv-row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="button_text" class="form-control form-control-solid"
                                    value="<?= set_value('button_text', $banner->button_text ?? '') ?>" placeholder="e.g. Shop Now" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6 fv-row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="button_url" class="form-control form-control-solid"
                                    value="<?= set_value('button_url', $banner->button_url ?? '') ?>" placeholder="e.g. /shop/women" />
                            </div>
                        </div>
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/slider-edit.js?ver=2.9"></script>
