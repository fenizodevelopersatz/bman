...
<h3 class="anchor fw-bold ">List Of Ranks</h3>
</div>
...
class="form-control form-control-solid w-250px ps-15" placeholder="Search rank" />
</div>


<a href="<?php echo base_url();?>rank-add" class="btn btn-light-primary">
...
<script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/rank-list.js?ver=5.9"></script>
