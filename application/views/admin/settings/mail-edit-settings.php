<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                ...
                ?>
                    ...
                    <h3 class="fw-bold m-0"><?php echo $card_title; ?></h3>
                     ...
                     <!-- INSEIDE FORM ENTER -->
                               ...
                               data-kt-redirect-url="<?php echo base_url(); ?>mail-settings" 
                               action="<?php echo base_url();?>mail-settings-update"
                               ...
                               <div class="card-body border-top p-9">
                                ...
                                <div class="col-lg-6">
                                <div class="row mb-6">
                                <label class="col-lg-8 col-form-label fw-semibold fs-6">SMTP Status<span class="text-danger"> * </span></label>
                                <div class="col-lg-4 fv-row">
                                <div class="input-group mb-5">
                                <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                <input class="form-check-input  h-30px w-50px"  name="smtp_status"  type="checkbox" value="1"
                                <?php echo $emailinfo->smtp_status ? "checked": ""; ?> 
                                id="smtp_status"/>
                                <label class="form-check-label" for="smtp_status">
                                </label>
                                </div>
                                </div>
                                </div>
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Host Name <span class="text-danger"> * </span></label>
                               ...
                               value="<?php echo $emailinfo->host; ?>" required>
                               </div>
                               </div>
                               </div>
                               ...
                               value="<?php echo $emailinfo->username; ?>" required>
                               </div>
                               </div>
                               </div>

                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Password <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="fa-solid fa-note-sticky "></i></span>
                               ...
                               value="<?php echo $emailinfo->password; ?>" required>
                               </div>
                               </div>
                               </div>

                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Secure <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="fa-solid fa-note-sticky "></i></span>
                               ...
                               value="<?php echo $emailinfo->smtpsecure; ?>" required>
                               </div>
                               </div>
                               </div>
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Port <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="fa-solid fa-note-sticky "></i></span>
                               ...
                               value="<?php echo $emailinfo->port; ?>" required>
                               </div>
                               </div>
                               </div>

                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Mail Send From <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="fa-solid fa-note-sticky "></i></span>
                               <input type="text" name="sendfrom" 
                               class="form-control form-control-lg form-control-solid" 
                               placeholder="Enter sendfrom" 
                               value="<?php echo $emailinfo->from_mail; ?>" required>
                               </div>
                               </div>
                               </div>
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Mail Sender Name <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="fa-solid fa-note-sticky "></i></span>
                               <input type="text" name="sendname" 
                               class="form-control form-control-lg form-control-solid" 
                               placeholder="Enter sendname" 
                               value="<?php echo $emailinfo->from_mail; ?>" required>
                               </div>
                               </div>
                               </div>
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/email-settings.js?ver=2.9"></script>
