<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
            ...
            <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                ...
                ?>
                    ...
                    <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                        ...
                        href="<?php echo base_url();?>/transfer-settings"> Transfer Settings                    
                        </a>
                        </li>
                        <!--end::Nav item-->
                        </ul>
                     ...
                     <!-- INSEIDE FORM ENTER -->
                               ...
                               <div class="card-body border-top p-9">
                                ...
                                <div class="col-lg-6">
                                <div class="row mb-6">
                                <label class="col-lg-8 col-form-label fw-semibold fs-6">Transfer Status<span class="text-danger"> * </span></label>
                                <div class="col-lg-4 fv-row">
                                <div class="input-group mb-5">
                                <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                <input class="form-check-input  h-30px w-50px" type="checkbox" value="1" name="transfer_status" 
                                <?php echo $withdraw_status ? "checked": ""; ?> 
                                id="transfer_status"/>
                                <label class="form-check-label" for="transfer_status">
                                </label>
                                </div>
                                </div>
                                </div>
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Min Transfer <span class="text-danger"> * </span></label>
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Max Transfer <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><?php echo $currency_info->currency_symbol; ?></span>
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Transfer Fee <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><?php echo $currency_info->currency_symbol; ?></span>
                               <input type="text" name="transfer_fee" 
                               class="form-control form-control-lg form-control-solid" 
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Transfer Daily Limit <span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><?php echo $currency_info->currency_symbol; ?></span>
                               <input type="text" name="transfer_daily_limit" 
                               class="form-control form-control-lg form-control-solid" 
                               placeholder="Transfer daily limit" 
                               ...
                               <small class="text-danger"> Notes : if set 0 unlimit </samll>
                                ...
                                <div class="col-lg-6">
                                <div class="row mb-6">
                                <label class="col-lg-8 col-form-label fw-semibold fs-6">Transfer Fee (%) or Fiat<span class="text-danger"> * </span></label>
                                <div class="col-lg-4 fv-row">
                                <div class="input-group mb-5">
                                <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                <select name="transfer_amount_type"  class="form-select" data-control="select2" data-placeholder="Select an option">
                                ...
                                id="transfer_notification_admin"/>
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/transfer-edit-settings.js?ver=2.9"></script>
