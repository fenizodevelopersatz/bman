...
<h3 class="anchor fw-bold ">List Of Token</h3>
</div>
...
class="form-control form-control-solid w-250px ps-15" placeholder="Search token" />
</div>


<a href="<?php echo base_url();?>token-add" class="btn btn-light-primary">
...
<script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/token-settings.js?ver=2.9"></script>
