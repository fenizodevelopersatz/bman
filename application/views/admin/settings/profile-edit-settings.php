<?php $this->load->view('admin/Layout/common_style');?>
                                ...
                                <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                                    ...
                                    id="kt_sing_in_two_factor_form">
                                        ...
                                        <div class="d-flex flex-center">
                                            ...
                                            data-kt-redirect-url="<?php echo base_url();?>profile-settings" 
 ...
 <?php } else { $this->session->unset_userdata('verify_payment_page');  ?>
                    ...
                    <h3 class="fw-bold m-0"><?php echo $card_title; ?></h3>
                               ...
                               data-kt-redirect-url="<?php echo base_url(); ?>profile-settings" 
                               action="<?php echo base_url();?>update-profile-settings"
                               ...
                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Name<span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="ki-duotone ki-pencil"><span class="path1"></span><span class="path2"></span></i></span>
                               <input type="text" name="admin_name" 
                               class="form-control form-control-lg form-control-solid" 
                               placeholder="Enter Your Name" 
                               value="<?php echo $admininfo->admin_name; ?>" required>
                               </div>
                               </div>
                               </div>

                               <div class="row mb-6">
                               <label class="col-lg-4 col-form-label fw-semibold fs-6">Email<span class="text-danger"> * </span></label>
                               <div class="col-lg-8 fv-row">
                               <div class="input-group mb-5">
                               <span class="input-group-text border-transparent " id="basic-addon1"><i class="ki-duotone ki-pencil"><span class="path1"></span><span class="path2"></span></i></span>
                               ...
                               value="<?php echo $admininfo->admin_email; ?>"
                               required >
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/profile-settings.js?ver=2.9"></script>
