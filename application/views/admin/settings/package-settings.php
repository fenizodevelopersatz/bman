<?php $this->load->view('admin/Layout/common_style');?>
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-5 mb-xxl-8">
                                                        ...
                                                        <div class="card-header mb-4 border-transparent">
                                                            <h3 class="anchor fw-bold ">List Of Package</h3>
                                                        </div>
                                                        ...
                                                        <div class="card-body pt-9 pb-9">
                                                            ...
                                                            <div class="d-flex flex-stack mb-5">
                                                                ...
                                                                <div class="d-flex align-items-center position-relative my-1">
                                                                    ...
                                                                    class="form-control form-control-solid w-250px ps-15" placeholder="Search Payment" />
                                                                </div>

                                                                <a href="<?php echo base_url();?>package-add" class="btn btn-light-primary">
        ...
        <?php $this->load->view('admin/Layout/common_script');?>
            ...
            <script src="<?php echo base_url();?>/assets/admin/js/custom/authentication/sign-in/package-settings.js?ver=2.9"></script>
