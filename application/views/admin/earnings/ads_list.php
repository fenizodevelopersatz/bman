...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                                        ...
                                        <div class="card mb-5 mb-xxl-8">
                                            ...
                                            <div class="card-body pt-9 pb-9">
                                                ...
                                                <div class="d-flex flex-stack mb-5">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/earning-ads/add"
                                                        ...
                                                        <div id="kt_datatable_example_export_menu"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="#" class="menu-link px-3"
                                                                    data-kt-export="copy">Copy to clipboard</a>
                                                            </div>
                                                            <div class="menu-item px-3">
                                                                <a href="#" class="menu-link px-3"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="#" class="menu-link px-3"
                                                                    data-kt-export="csv">Export as CSV</a>
                                                            </div>
                                                            <div class="menu-item px-3">
                                                                <a href="#" class="menu-link px-3"
                                                                    data-kt-export="pdf">Export as PDF</a>
                                                            </div>
    ...
    <!-- ✅ NEW JS -->
    <script
        src="<?php echo base_url(); ?>/assets/admin/js/custom/authentication/sign-in/earning-ads-list.js?ver=1.0"></script>
