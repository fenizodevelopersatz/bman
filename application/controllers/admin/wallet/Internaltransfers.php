...
class Internaltransfers extends CI_Controller
{
     ...
     * Only the source's downline (exchange/earning/staking) or left/right binary
     * leg downline, up to bonusLegDepth() levels (bonus), are returned — the
     * admin cannot pick an invalid recipient.
