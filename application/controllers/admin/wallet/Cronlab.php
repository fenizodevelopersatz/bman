    ...
    public function index()
    {
        ...
        $data = [
            ...
            'jobs' => [
                ...
                ['key' => 'roi_maturity', 'label' => 'ROI Maturity Process', 'type' => 'roi', 'endpoint' => 'cron/roi_maturity/process', 'method' => 'GET', 'description' => 'Process matured staking investments and release final ROI payouts to user earning wallets. Distributes remaining ROI and records transactions in audit log.'],
