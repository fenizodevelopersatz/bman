...
private function getMiningHistory($userIds, $decimalCurrency, $currencySymbol) {
    ...
    public function myreferralHistory()
    {
        ...
        // Locked Wallet (BMAN) totals of each leg's whole downline team — shown
        // as "Left/Right Users Investment" on the referrals page. Investment is always
        // tracked via locked wallet staking, so use lock_wallet totals.
        $left_locked_wallet  = (float)($binary_info['left_lock_wallet'] ?? 0);
        $right_locked_wallet = (float)($binary_info['right_lock_wallet'] ?? 0);
        ...
        $this->data['left_invest']  = $left_locked_wallet;
        $this->data['right_invest'] = $right_locked_wallet;
