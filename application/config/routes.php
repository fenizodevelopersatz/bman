...
$route['admin/dashboard/bonus-reduction'] = 'admin/dashboard/Dashboard/bonus_reduction';
$route['admin/dashboard/roi-liability'] = 'admin/dashboard/Dashboard/roi_liability';
$route['admin/dashboard/roi-liability-periods'] = 'admin/dashboard/Dashboard/roi_liability_periods';
$route['admin/dashboard/treasury'] = 'admin/dashboard/Dashboard/treasury';
...
$route['admin/dashboard/activity-trend'] = 'admin/dashboard/Dashboard/activity_trend';
$route['admin/dashboard/rank-summary'] = 'admin/dashboard/Dashboard/rank_summary';
$route['admin/dashboard/rank-members/(:num)'] = 'admin/dashboard/Dashboard/rank_members/$1';
...
$route['admin/settings/twofa/setup-request'] = 'admin/settings/Advancesettings/admin_twofa_setup_request';
$route['admin/settings/twofa/setup-verify'] = 'admin/settings/Advancesettings/admin_twofa_setup_verify';
...
$route['admin/member/profile-roi/(:num)'] = 'admin/member/Membermanagement/profile_roi/$1';
$route['admin/member/profile-staking/(:num)'] = 'admin/member/Membermanagement/profile_staking/$1';
$route['admin/member/profile-matching/(:num)'] = 'admin/member/Membermanagement/profile_matching/$1';
$route['admin/member/profile-ranks/(:num)'] = 'admin/member/Membermanagement/profile_ranks/$1';
$route['admin/member/profile-wallet-history/(:num)'] = 'admin/member/Membermanagement/profile_wallet_history/$1';
$route['admin/member/profile-transaction/(:num)/(:num)'] = 'admin/member/Membermanagement/profile_transaction_detail/$1/$2';
...
$route['admin/staking/rank-files'] = 'admin/staking/Rankmanagement/files';
$route['admin/staking/rank-files/upload']['post'] = 'admin/staking/Rankmanagement/files_upload';
$route['admin/staking/rank-files/delete/(:num)']['post'] = 'admin/staking/Rankmanagement/files_delete/$1';
...
$route['user/recentWalletTransactionsAjax'] = 'user/user/recentWalletTransactionsAjax';
$route['user/binarySummaryAjax'] = 'user/user/binarySummaryAjax';
