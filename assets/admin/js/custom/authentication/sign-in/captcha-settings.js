...
//                         validators: {
//                             notEmpty: {
//                                 message: "Secretkey Key is required."
//                             }
//                         }
//                     }
//                 },
...
//                                 if (res.status) {
//                                     Swal.fire({
//                                         text: "Captcha Settings Updated Successfully!",
//                                         icon: "success",
//                                         buttonsStyling: false,
//                                         confirmButtonText: "Ok, got it!",
//                                         customClass: {
            ...
            init: function () {
                ...
                r = FormValidation.formValidation(t, {
                    fields: {
                        sitekey: {
                            validators: {
                                notEmpty: { message: "Site Key is required." }
                            }
                        },
                        secretkey: {
                            validators: {
                                notEmpty: { message: "Secretkey Key is required." }
                            }
                        }
                    },
                    plugins: {
