...
//                 stateSave: true,
//                 ajax: {
//                     url: base_url + "announcement-list-cms",
//                     type: "GET",
//                 },
//                 columns: [
//                     { data: 'RecordID' },
...
//                         //     icon: 'info',
//                         //     title: 'Demo Version',
//                         //     text: 'You Can delete annoncement.',
...
//                         //     icon: 'info',
//                         //     title: 'Demo Version',
//                         //     text: 'You Can not change annoncement status.',
//                         //     confirmButtonText: 'Ok, got it!',
//                         //     customClass: {
//                         //         confirmButton: 'btn btn-primary'
//                         //     },
...
$(document).ready(function () {
    ...
    var KTDatatablesExample = function () {
        ...
        var initDatatable = function () {
            // const tableRows = table.querySelectorAll("tbody tr"); // not used
            datatable = $(table).DataTable({
                searchDelay: 500,
                processing: true,
                serverSide: true,
            ...
            $(document).on("click", ".btn-delete", function (e) {
                ...
                Swal.fire({
                    ...
                    if (isDemoMode()) {
                        demoBlockAlert("You Can not delete announcement.");
                        return;
                    }
                        ...
                        success: function (response) {
                            if (response.status === "success") {
                                Swal.fire({
                                    ...
                                    // better: reload datatable (keeps pagination)
            ...
            $(document).on("change", ".template_status", function (e) {
                ...
                Swal.fire({
                    ...
                    // ✅ DEMO MODE BLOCK (stop before API)
                    if (isDemoMode()) {
                        demoBlockAlert("You Can not change announcement status.");
                        return;
                    }
