            ...
            r = FormValidation.formValidation(t, {
                fields: {
                    min_swap: {
                        validators: {
                            notEmpty: {
                                message: "Minimum swap is required."
                            },
                            numeric: {
                            ...
                            greaterThan: {
                                min: 0,
                                message: "Minimum swap must be greater than 0."
                            }
                        }
                    },
                    max_swap: {
                        validators: {
                            notEmpty: {
                                message: "Maximum swap is required."
                            },
                            numeric: {
                                message: "Only numbers are allowed."
                            },
                            greaterThan: {
                                min: 0,
                                message: "Maximum swap must be greater than 0."
                            }
                        }
                    },
                    swap_fee: {
