...
//                         validators: {
//                             notEmpty: {
//                                 message: "The Email Secure is Required"
//                             }
//                         }
//                     },
//                     port: {
//                         validators: {
//                             notEmpty: {
//                                 message: "The Email Port is Required"
//                             }
//                         }
//                     },
//                     sendfrom: {
//                         validators: {
//                             notEmpty: {
//                                 message: "The Email Sendfrom is Required"
//                             }
//                         }
//                     },
//                     sendname: {
//                         validators: {
//                             notEmpty: {
//                                 message: "The Email Sendname is Required"
//                             }
//                         }
//                     },
//                 },
    ...
    var KTSigninGeneral = function () {
        ...
        return {
            init: function () {
                ...
                r = FormValidation.formValidation(t, {
                    fields: {
                        host: { validators: { notEmpty: { message: "The Email Subject is Required" } } },
                        username: { validators: { notEmpty: { message: "The Email Username is Required" } } },
                        password: { validators: { notEmpty: { message: "The Email Password is Required" } } },
                        secure: { validators: { notEmpty: { message: "The Email Secure is Required" } } },
                        port: { validators: { notEmpty: { message: "The Email Port is Required" } } },
                        sendfrom: { validators: { notEmpty: { message: "The Email Sendfrom is Required" } } },
                        sendname: { validators: { notEmpty: { message: "The Email Sendname is Required" } } },
                    },
                    plugins: {
                        trigger: new FormValidation.plugins.Trigger(),
                        bootstrap: new FormValidation.plugins.Bootstrap5({
