...
//                             var delete_url = base_url + 'delete-ip/' + encodedAgentId;
//                             return `
...
$(document).ready(function () {
    ...
    var KTDatatablesExample = function () {
        ...
        var initDatatable = function () {
            ...
            // ✅ If this page doesn't need status toggle, you can remove this block.
            $(document).on("change", ".currency_status", function (e) {
                e.preventDefault();
            ...
            // ✅ Delete IP (with demo mode block)
            $(document).on("click", ".btn-delete", function (e) {
                e.preventDefault();
                        ...
                        success: function (response) {
                            if (response.status === "success") {
                                Swal.fire({
                                    ...
                                    // better than row.remove(): keep datatable correct
