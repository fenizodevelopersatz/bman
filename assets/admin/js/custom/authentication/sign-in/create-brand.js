...
/* =======================
   DEMO MODE HELPERS
   - reads from window.APP_CONFIG.DEMO (recommended)
   - fallback: window.DEMOVERSION (if you define it in PHP as JS var)
======================= */
function isDemoMode() {
    return !!(
...
var KTSigninGeneral = (function () {
    ...
    return {
        init: function () {
            ...
            // ✅ redirect url (fix: your old code used redirectUrl without defining)
            var redirectUrl = t.getAttribute("data-kt-redirect-url") || "";
            ...
            success: function (response) {
                if (response && response.status === "success") {
                    Swal.fire({
                        ...
                        // optional: reload / remove preview block
                        location.reload();
                    });
                } else {
                    Swal.fire({
